<?php
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']))
	{
		...
		$pdf->SetTitle("descarga de informe");
		$pdf->SetFont('Arial', 'B', 9);
		$pdf->Cell(60, 5, utf8_decode($resultado['nombre']), 0, 1, 'C');// NOMBRE DE EMPRESA
		$pdf->Ln();
		...
		$pdf->SetFont('Arial', 'B', 7);
		$pdf->Cell(16, 15, "Fecha: ", 0, 0, 'R');
		$pdf->SetFont('Arial', '', 7);
		$pdf->Cell(25, 15, $result_venta['fecha'], 0, 1, 'R');
		$pdf->SetFont('Arial', 'B', 7);
		...
		//DETALLES
		$pdf->Cell(75, 5, "Detalle de Informe", 0, 1, 'L');
