      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="" method="post">
            ...
            <div class="form-group">
              <label for="precio">Valor Solicitado</label>
              <input type="text" placeholder="Ingrese Valor" class="form-control" name="precio" id="precio" value="<?php echo $data_producto['precio']; ?>">

            </div>
            <input type="submit" value="Actualizar Prestamos" class="btn btn-primary">
          </form>
        </div>
      </div>
    </div>
