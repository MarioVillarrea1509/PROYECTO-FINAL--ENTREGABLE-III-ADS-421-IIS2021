            ...
            <div class="card">
                <form action="" autocomplete="off" method="post" class="card-body p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese tipo de pago" name="proveedor" id="nombre" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="contacto">Nombre del cliente</label>
                        <input type="text" placeholder="Ingrese nombre del cliente" name="contacto" id="contacto" class="form-control">
                    </div>
                    <div class="form-group">
