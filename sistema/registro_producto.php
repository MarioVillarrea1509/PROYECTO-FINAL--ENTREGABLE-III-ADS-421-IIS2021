 ...
 <div class="container-fluid">
   ...
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
     <h1 class="h3 mb-0 text-gray-800">Panel de Registros</h1>
     ...
     <div class="col-lg-6 m-auto">
       <form action="" method="post" autocomplete="off">
         ...
         <div class="form-group">
           ...
           <input type="text" placeholder="Ingrese nombre del cliente" name="producto" id="producto" class="form-control">
         </div>
         <div class="form-group">
           <label for="precio">Monto del prestamo</label>
           <input type="text" placeholder="Ingrese monto" class="form-control" name="precio" id="precio">
         </div>
         <div class="form-group">
           <label for="cantidad">Cantidad de prestamos a solicitar</label>
