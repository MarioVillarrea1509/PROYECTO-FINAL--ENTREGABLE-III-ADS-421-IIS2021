        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post">
                ...
                <div class="form-group">
                    <label for="precio">Valor Solicitado Actual </label>
                    <input type="number" class="form-control" value="<?php echo $data_producto['precio']; ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="precio">Cantidad solicitud permitidas </label>
                    <input type="number" class="form-control" value="<?php echo $data_producto['existencia']; ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="precio">Nuevo Valor</label>
                    <input type="number" placeholder="Ingrese el nuevo valor" name="precio" class="form-control" value="<?php echo $data_producto['precio']; ?>">
                </div>
                <!-- <div class="form-group">
